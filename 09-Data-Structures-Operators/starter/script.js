...
const calcAverageHumanAge = (ages) => {
  return ages.map(dogAge => dogAge <= 2 ? 2 * dogAge : 16 + dogAge * 4).filter(age => age >= 18).reduce((acc, cur, i, arr) => {
    console.log(acc);
...
console.log("🚀 ~ file: script.js:200 ~ avg1:", avg1)
const avg2 = calcAverageHumanAge([16, 6, 10, 5, 6, 1, 4])
console.log("🚀 ~ file: script.js:202 ~ avg2:", avg2)
